...
import java.sql.Connection;//Librerias para las conexiones a la BD
...
public class ConexionCRUD {
    ...
    */
    private final String servidor = "jdbc:mysql://127.0.0.1:3306/bd_recurso_humano1";
...
//B.) ESTABLECER LOS METODOS PARA LA CONEXION A LA BD CON LAS VARIABLES (CONSTANTES) ANTERIORES
...
//C.) CREAR EL METODO PARA GUARDAR LOS CRITERIOS EN LA BD
...
//D.) METODO PARA ACTUALIZAR Y ELIMINAR LOS REGISTROS
    ...
    //E.) METODO PARA HACER LAS CONSULTAS DE REGISTROS DE LA BD
